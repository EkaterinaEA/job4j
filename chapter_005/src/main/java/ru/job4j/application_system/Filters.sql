...
Select p.id, p.name, p.expired_date, p.price from product as p Inner join type as t On p.type_id = t.id
where t.name= 'СЫР';
...
Select* from product
where expired_date between '2020-06-01' and '2020-06-30';
